...
cd atsd-api-test
mvn '-Dtest=!PropertyDeleteTest#*ExactFalse, !MessageQueryStatsTest' clean test -Dmaven.test.failure.ignore=false -DserverName="localhost" -Dlogin=$axiname -Dpassword=$axipass 
